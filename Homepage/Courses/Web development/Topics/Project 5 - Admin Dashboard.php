...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>Project 5 - Admin Dashboard</title>
...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Project 5 - Admin Dashboard</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/project-5-admin-dashboard&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        47 Project 5 – Teaser</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        48 Project 5 – Menus</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        49 Project 5 – Sidebar</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        50 Project 5 – Content</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        51 Project 5 – Final Results</td>
    </tr>
  </tbody>
</table>
