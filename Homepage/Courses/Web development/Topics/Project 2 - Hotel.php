...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Project 2 - Hotel</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/project-2-hotel&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        22 Project 2 – Hotel</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        23 Project 2 – Hotel Part 2</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        24 Styling The Links</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        25 Classes And ID In CSS</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        26 Designing A Menu From Scratch</td>
    </tr>
    <tr>
      <td>
        <i class="fa-solid fa-circle-play"></i> 
        27 Parallax Effect</td>
    </tr>
    <tr>
      <td>
        <i class="fa-solid fa-circle-play"></i> 
        28 Gradient In CSS</td>
    </tr>
  </tbody>
</table>
