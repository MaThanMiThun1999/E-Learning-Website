...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>Project 6 - Random Password Generator</title>
...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Project 6 - Random Password Generator</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/86-project-random-password-generator&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
...
<!-- table topics starts  -->
  ...
  <tbody>
      <td><i class="fa-solid fa-circle-play"></i> 
        85 Project – Random Password Gen</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        86 Project – Random Password Gen – Designing</td>
    </tr>
  </tbody>
</table>
