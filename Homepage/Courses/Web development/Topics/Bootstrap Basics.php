...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Bootstrap Basics</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/30-installing-bootstrap&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        29 Introduction To Bootstrap</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        30 Installing Bootstrap</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        31 Bootstrap – Overview</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        32 Grid System</td>
    ...
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        33 Bootstrap Contents</td>
    </tr>
    <tr>
      <td>
        <i class="fa-solid fa-circle-play"></i> 
        34 Bootstrap Components</td>
    </tr>
  </tbody>
</table>
