...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Jquery</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/jquery_202311&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        87 Intro To JQuery</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        88 Selecting Class And ID With JQuery</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        89 Attr And Val</td>
    ...
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        90 Event Listeners In JQuery</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        91 Keypress Event In JQuery</td>
    </tr>
    <tr>
      <td>
        <i class="fa-solid fa-circle-play"></i> 
        92 On Event Method In JQuery</td>
    </tr>
    <tr>
      <td>
        <i class="fa-solid fa-circle-play"></i> 
        93 Animations With JQuery</td>
    </tr>
  </tbody>
</table>
