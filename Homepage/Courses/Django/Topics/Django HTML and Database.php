...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>Django HTML and Database</title>
...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Django HTML and Database</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/html-and-mysql-in-django&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
...
<!-- table topics starts  -->
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 6 Templates in Django</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 7 Creating HTML Forms in Django</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 8 Get & POST Methods in Django</td>
    </tr>
  </tbody>
</table>
