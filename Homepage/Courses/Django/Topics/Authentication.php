...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Authentication</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/14-user-registration-with-server-side-validation&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
...
<!-- table topics starts  -->
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 13 Building a Registration Template</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 14 Registration server-side validate</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 15 Login with server-side validate</td>
    </tr>
  </tbody>
</table>
