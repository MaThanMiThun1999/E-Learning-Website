...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Image Uploading</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/upload-image-in-django&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
...
<!-- table topics starts  -->
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 16 Upload Image in Django</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 17 Display Image in Django</td>
    </tr>
  </tbody>
</table>
