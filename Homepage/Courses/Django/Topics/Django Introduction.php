...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">Django Introduction</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/1-introduction-to-django_202311&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
...
<!-- table topics starts  -->
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 1 Introduction to Django</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 2 Download & Installation of Django</td>
    </tr>
  </tbody>
</table>
