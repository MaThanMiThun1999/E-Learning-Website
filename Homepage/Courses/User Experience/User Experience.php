...
<main>
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">User Experience (UX)</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/introduction-to-user-experience-the-basics-of-ux_20231109_0246" ?rel=0;autoplay=1;modestbranding=1"  webkitallowfullscreen="true" mozallowfullscreen="true" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen frameborder="0"></iframe>
...
<ul class="accordion">
  <li>
    <p class="link"><a class="dropdown-item disabled a" aria-disabled="true">Basic Understanding of UX<i class="fa fa-toggle-down"></i></a></p>
    <ul class="submenu">
      <li><a class="startlink" href="./Topics/Basic Understanding of UX.php">Start Learning</a></li>
      <li><a class="dropdown-item disabled a" aria-disabled="true">1 What is UX?</a></li>
      <li><a class="dropdown-item disabled a" aria-disabled="true">2 The UX Process</a></li>
      <li><a class="dropdown-item disabled a" aria-disabled="true">3  Difference Between UX and UI</a></li>
      </ul>

    <li>
      <p class="link"><a class="dropdown-item disabled a" aria-disabled="true">Components of UX<i class="fa fa-toggle-down"></i></a></p>
      <ul class="submenu">
        <li><a class="startlink" href="./Topics/Components of UX.php">Start Learning</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">4  Components of UX</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">5 Understanding the Business</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">6 Stakeholder Mapping</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">7 User Research</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">8 Persona Mapping</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">9 User Journey Mapping</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">10 Writing a Problem Statement</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">11 Hierarchy of Information</a></li>
        <li><a class="dropdown-item disabled a" aria-disabled="true">12 Understanding Navigation Flows</a></li>
      </ul>
      ...
      <div class="row g-5">
        <div class="col-md-12">
          ...
          <article class="blog-post">
            ...
            <p class="content crpara">Anyone who wants to learn about UX designing can take up the User Experience Design Course. <strong>TamilCodeLab</strong> offers this course in Tamil for Tamil medium students.</p>
            <hr>
            <p class="content crpara"><strong>User Experience Design Online Course</strong> from TamilCodeLab can help web-developers shift to the field of product design research.</p>
            <hr>
            <p class="content crpara">Other courses to take up after the User Experience Design Course are:</p>
            <ul>
                <li>&#x25cf; Web designing</li>
        ...
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <ul class="list-unstyled mt-6 mb-4 listcard">
              ...
              <li><i class="fa-regular fa-clock"></i> 2 hours Duration</li>
          ...
          <div class="card mb-4 rounded-3 shadow-sm">
            ...
            <div class="card-body">
              ...
              <ul class="list-unstyled text-start mt-6 mb-4">
                ...
                <li>&#9726; Download the Figma app on Desktop for macOS or Windows.</li>
              </ul>
            </div>
          </div>
        </div>
