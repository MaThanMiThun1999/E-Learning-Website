...
<!-- vide start  -->
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/7-php-basics-part-5&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
  ...
  <tbody>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        3 PHP Basics Part 1</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        4 PHP Basics Part 2</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        5 PHP Basics Part 3</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        6 PHP Basics Part 4</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        7 PHP Basics Part 5</td>
    </tr>
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        8 PHP Basics Part 6 (Superglobals)</td>
    </tr>
  </tbody>
</table>
