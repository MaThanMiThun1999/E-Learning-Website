...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>PHP And MySQL Introduction</title>
...
<!-- vide start  -->
  ...
  <div class="workTitle">
    ...
    <h1 class="singletitle">PHP And MySQL Introduction</h1>
  </div>
  <div id="info">
  ...
  <div class="holder">
    <div class="video-container">
      <iframe src="https://archive.org/embed/php-and-mysql-installation&playlist=1&list_height=50"?rel=0;autoplay=1;modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; eager;" allowfullscreen ></iframe>
...
<!-- table topics starts  -->
  ...
  <tbody>
    ...
    <tr>
      <td><i class="fa-solid fa-circle-play"></i> 
        2 VSCode and PHP Installation</td>
    </tr>
  </tbody>
</table>
